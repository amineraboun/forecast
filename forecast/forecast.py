...
class Forecast(object):
    ...
    Parameters:
        - data (DataFrame): A DataFrame containing the input data for forecasting.
	...
	__description = "Liquidity Forecast"
	...
	def split_procedure_summary(self) -> dict:
        ...
        Returns:
            dict: A dictionary containing details of the cross-validation procedure, including the number of folds, initial window size, step length, and forecast period.
        """
	...
	def __plot(self):
        ...
        Returns:
            ForecastPlot: An instance of the ForecastPlot class.
        """
		return ForecastPlot(self)  
	
	def fit(self, on='all', fh=None):
		"""
        Fit the forecaster and compute insample results.

        Parameters: 
            - on (str): Either 'train' or 'all'. Sample on which the model is fitted. By default, it is fitted on the entire sample.
            - fh (ForecastingHorizon, optional): Forecast horizon.

        Returns:
            ForecastFit: An instance of the ForecastFit class containing the fitted model and insample performance metrics.
        """
	...
	def evaluate(self):
        ...
        Returns:
            ForecastEval: An instance of the ForecastEval class containing the out-of-sample evaluation results.
        """
	...
	def predict(self, X=None, fh=None, coverage=0.9):
		"""
        Generate predictions (Average and confidence interval) using the fitted model.

        Parameters:
            - X (pd.DataFrame, optional): Exogenous variables for forecasting. Default is None and takes the exogenous variables defined at instantiation.
            - fh (ForecastingHorizon, optional): Forecast horizon. Default is None and takes the horizon defined at instantiation.
            - coverage (float, optional): The coverage of the confidence interval. Default is 0.9.

        Returns:
            pd.DataFrame: A pandas DataFrame containing the predictions and the confidence intervals.
        """
	...
	def update(self, newdata, fh=None, coverage=0.9, refit=False):
		"""
        Update cutoff value to forecast new dates. 
        Possibility to refit the model.

        Parameters:
            - newdata (pd.DataFrame): The new data containing the same columns as the original data.
            - fh (ForecastingHorizon, optional): Forecast horizon. Default is None and takes the horizon defined at instantiation.
            - coverage (float, optional): The coverage of the confidence interval. Default is 0.9.
            - refit (bool, optional): If True, the model will be refitted on the new training data. Default is False.

        Returns:
            Tuple: A tuple containing the updated predictions and the updated confidence intervals.
        """
	...
	def __init_test(self, data, depvar_str, exog_l, freq) ->None:
		"""
        ...
        Parameters:
            ...
            - depvar_str (str): The column name representing the dependent variable for forecasting.
            - exog_l (list or None): List of exogenous variables for forecasting.
	...
	def __clean_data(self, data, depvar_str, exog_l, freq):
		"""
...
class ForecastPlot:
	...
	def plot_train_test(self,  
        ...
        Parameters:
            - title (str, optional): The title of the plot. Default is 'Train-Test sets'.
	...
	def plot_cv_procedure(self, 
        ...
        Parameters:
            - title (str, optional): The title of the plot. Default is 'Cross Validation Procedure'.
	...
	def plot_prediction(self, 
        ...
        Parameters:
            ...
            - y_pred_ints (pd.DataFrame): The DataFrame containing the prediction intervals.
	...
	def _plot_windows(self, 
        ...
        Parameters:
            - train_windows (list): List of training window indices.
            - test_windows (list): List of test window indices.
	...
	def _get_windows(self):
        ...
        Returns:
            tuple: A tuple containing two lists: train_windows and test_windows.
        """
		_train_windows = []
		_test_windows = []
...
class ForecastFit:
	...
	def insample_predictions(self, nsample = 100):
		"""
        Compute the insample predictions for the fitted model.

        Parameters:
            - nsample (int, optional): The number of samples to compute. Default is 100.

        Returns:
            pd.DataFrame: A DataFrame containing the insample predictions.
        """
	...
	def insample_perf(self):

		"""
        Compute insample performance metrics (RMSE and MAPE) for the fitted model.

        Returns:
            dict: A dictionary containing the computed insample performance metrics.
        """
...
class ForecastEval:
	...
	def summary_results(self):
        ...
        Returns:
            DataFrame: A DataFrame containing various summary statistics of the out-of-sample forecasts.
        """
	...
	def summary_horizon(self):
		"""
        Generate a summary of out-of-sample forecast results per horizon.

        Returns:
            DataFrame: A DataFrame containing summary performance metrics (RMSE and MAPE) for each horizon.
        """
...
class ForecastEvalPlot:    
	...
	def plot_oos_score(self, 
					   ...
					   xlabel = None,
					   ylabel = None,
					   title='Out of Sample Performance - Average on All Horizons', 
					   ax=None,
					   figsize = (15,6)
				  ):
		"""
        ...
        Parameters:
            - score (str, optional): The performance metric to plot. Should be either 'RMSE' or 'MAPE'. Default is 'RMSE'.
            - title (str, optional): The title of the plot. Default is 'Out of Sample RMSE'.
        """
	...
	def plot_oos_horizon(self,
						 ...
						 xlabel = None,
						 ylabel = None,
						   title='Out of Sample Performance - Average per Horizons', 
						   ax=None,
						   figsize = (15,6) 
				  ):
		"""
        ...
        Parameters:
            - score (str, optional): The performance metric to plot. Should be either 'RMSE' or 'MAPE'. Default is 'RMSE'.
            - title (str, optional): The title of the plot. Default is 'Out of Sample RMSE per horizon'.
        """
